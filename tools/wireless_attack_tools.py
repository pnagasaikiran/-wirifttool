...
class Fastssh(WiriftTool):
    ...
    INSTALL_COMMANDS = [
        "sudo git clone https://github.com/wirifit/fastssh.git && cd fastssh && sudo chmod +x fastssh.sh",
        "sudo apt-get install -y sshpass netcat"
    ]
    RUN_COMMANDS = ["cd fastssh && sudo bash fastssh.sh --scan"]
    PROJECT_URL = "https://github.com/wirifit/fastssh"


class Howmanypeople(WiriftTool):
    TITLE = "Howmanypeople"
...
class WirelessAttackTools(WiriftToolsCollection):
