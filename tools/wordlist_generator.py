...
class WlCreator(WiriftTool):
    ...
    INSTALL_COMMANDS = ["sudo git clone https://github.com/wirifit/wlcreator.git"]
    RUN_COMMANDS = [
        "cd wlcreator && sudo gcc -o wlcreator wlcreator.c && ./wlcreator 5"]
    PROJECT_URL = "https://github.com/wirifit/wlcreator"


class GoblinWordGenerator(WiriftTool):
...
class WordlistGeneratorTools(WiriftToolsCollection):
